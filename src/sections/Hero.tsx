...
import designeg1 from "@/assets/images/design-example-1.png"
    ...
    <section className="py-24 overflow-x-clip" style={{
        ...
        <div className="container relative">
            <motion.div 
                ...
                <Image src={designeg1} draggable="false" alt="image1" />
            </motion.div>
            <motion.div 
                ...
                <Image src={designeg2} draggable="false" alt="image2" />
            </motion.div>
            <motion.div 
            ...
            <h1 className="text-6xl font-medium md:text-7xl text-center mt-6 lg:text-8xl">Impactful design, created effortlessly</h1>
            ...
            <div className="flex border border-white/15 rounded-full p-2 mt-8 max-w-lg mx-auto">
                ...
                className="bg-transparent md:px-4 border-none outline-none md:flex-1"/>
                <Button type="submit" 
                variant="primary" 
