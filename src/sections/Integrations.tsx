...
import IntegrationColumn from "@/components/IntegratioColum";
        ...
        <section className="py-24 overflow-hidden">
            <div className="container">
                <div className="grid lg:grid-cols-2 items-center lg:gap-16">
                    ...
                    <p className="text-white/50 mt-4 text-lg">Layers seamlessely connects with your favorite tools making it easy
                        to plug into any workflow and collaborate with other platforms.
                    </p>
                    </div>
                    <div>
